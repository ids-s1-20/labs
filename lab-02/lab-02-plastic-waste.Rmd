...
- Recall that RStudio is divided into four panes. Can you name them all and briefly describe their purpose?
...
*Hint: If you're not sure or want to verify, run the command `?NA` which will lead you to the documentation.*
...
We don't expect you to complete all the exercises within the hour reserved for the lab. Ideally, you should've got to this point. If you still have some time left, move on to the remaining exercises below. Otherwise you should take time to complete them after the lab. If you haven't even had time to finish the exercises above, please ask for help!
