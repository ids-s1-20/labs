...
**EVERYONE:** Go to course [GitHub organization](https://github.com/ids-s1-20) and locate your Lab 03 repo, which should be named `lab-03-nobel-laureates-YOUR_TEAMNAME`.
...
In your lab template this week (and going forward) you'll see markers that indicate exercise numbers as well as narrative and code portions.
Please don't remove or alter these markers as they are used for automarking your work.
If you remove or alter them, your work might not be marked properly.
