...
Before we get to work let's play a little game! Will the following graphs fool you or can you pinpoint what they've done to mislead you?

## Discuss!

- How many errors could you find? 
- In what way do you think these errors would deceive the less observant?
- How would you fix these graphs?

### Who's happiest?

```{r echo=FALSE, fig.fullwidth=TRUE}
knitr::include_graphics("img/nyt-04happy-top.jpg")
```
