...
Please do this before you come and join the workshop!
...
Make sure it compiles without errors. The output will be in the markdown 
...
<p><span style="
  ...
  border-radius:4px;
">
  In-person workshop starts here!
</span></p>

# Warm-up with your team

Today's warm-up is on the importance of context. Discuss the following situation with your group.

We are testing a drug for cats and dogs and record the data for
each of them separately. We observe the following.

Out of 100 dogs who were given the treatment all of them survive and out of 200 dogs who weren't given the treatment only 150 of them survive. Does it seem like the treatment is effective?

Out of 200 cats who were given the treatment, only 50 of them survived and out of 100 who weren't given the treatment, none of them survived. Is the treatment effective?

Now combine the data, can we say that the treatment is effective for the whole group of cats and dogs? What went wrong?

Here's a nice way of viewing this problem. Try drawing a table like the one below and fill in the cells with the _percentage_ of cats, dogs and both, who survived. 
...
Compare the percentages in each column and see what it tells you about the effectiveness of the drug. Weird, right?
...
In this lab we will work with data on age, smoking, and mortality from a 
...
<p><span style="
  ...
  border-radius:4px;
">
  End of in-person workshop.
</span></p>

# Wrapping up

This is the end of the "in person" workshop. Feel free to continue with the following exercises if you're confident with what you've done so far, otherwise please ask questions!
