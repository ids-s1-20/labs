...
We are testing a drug and we decide to keep the data from cats and dogs separate. We observe the following.
...
Here's a nice way of viewing this problem. Try drawing a table like the one below and fill in the cells with the percentage of people who survived. 
