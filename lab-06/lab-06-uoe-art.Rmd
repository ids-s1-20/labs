...
Now let's ourselves to  Webscraping.
...
Recall that you were asked to scrap the titles on the first 10 pieces in the given collection. Before we get to work let's quickly go through that task.  

## Discuss!

- How can you identify the tags for the relevant nodes? 
- Which function did you use to extract the text?
- What does str_squish() do?


# Workshop exercises

## Scraping a single page (continuation)
